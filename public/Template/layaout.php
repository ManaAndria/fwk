	    ...
	    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	      <ul class="nav navbar-nav">
			...
			<?php if ($Auth->isConncetd("Mana", "03aout1991")) { ?>
				<form class="navbar-form navbar-right" method="post" action="index.php?page=deconnexion">
					<button type="submit" class="btn btn-warning">Deconnecter</button>
				</form>
			<?php } else { ?>
				<form class="navbar-form navbar-right" method="post" action="index.php?page=connexion">
